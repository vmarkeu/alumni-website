...
$name = $_SESSION['searchalumniname'];
$sql = "SELECT Alumni_ID, Alumni_Name, DOB, Sex, Contact, Email, Course, Intake, Graduate, Alumni_Password, Profile_Pic FROM alumni WHERE Alumni_Name = '$name'";
...
<html>
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="rightcolumn">
                        ...
                        <button class="backbutton" onclick="window.location.replace('AlumniViewUser.php')">Back</button>
                    </div>
                </div>
            </fieldset>
        </div>
    ...
    <footer class="footer">
        ...
        <div class="footerright">
            <div class="footerbox">
                <form action="AlumniSearchUser.php" method="POST">
                    <h1>NEWSLETTER</h1>
