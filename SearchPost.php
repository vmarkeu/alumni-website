...
//---------------------------retrive data part --------------------------
$name = $_SESSION['searchpostname'];
$sql = "SELECT post_id, alumni_name, content, profile_pic FROM post, alumni WHERE alumni.alumni_name = '$name' AND post.alumni_id = alumni.alumni_id ORDER BY post.post_id DESC";
        ...
        <div class="row">
            <div class="leftcolumn">
                ...
                <?php
                    ...
                    echo '<script>alert("Alumni name is not found or this alumni does not have any post.")</script>';
            ...
            <div class="rightcolumn">
                ...
                <button class="backbutton" onclick="window.open('AlumniUserPost.php', '_self')">Back to Alumni Newsfeed</button>
